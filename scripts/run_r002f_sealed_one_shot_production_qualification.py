...
def _bootstrap(argv: list[str]) -> Path:
    if sys.flags.isolated != 1 or sys.flags.dont_write_bytecode != 1:
        raise SystemExit("sealed one-shot must use Python -I -B")
    ...
    if (
        ...
        raise SystemExit("sealed execution bootstrap authority is invalid")
...
from hms_gpt_vps.r002f_sealed_one_shot_entrypoint import main
